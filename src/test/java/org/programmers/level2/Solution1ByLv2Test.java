...
public class Solution1ByLv2Test {
    /*
        [요격 시스템]
        ...
        각 폭격 미사일의 x 좌표 범위 목록 targets이 매개변수로 주어질 때, 모든 폭격 미사일을 요격하기 위해
        필요한 요격 미사일 수의 최솟값을 return 하도록 solution 함수를 완성해 주세요.
    */

    @Test
    public void solution3Test() {
        Solution1ByLv2 solutionLv21 = new Solution1ByLv2();

        int[][] testParam = {{4, 5}, {4, 8}, {10, 14}, {11, 13}, {5, 12}, {3, 7}, {1, 4}};

        int result = solutionLv21.solution(testParam);
