...
public class Solution6ByLv2Test {
    ...
    */
    ...
    @Test
    public void solution5byLv2Test1() {
        Solution6ByLv2 solution6ByLv2 = new Solution6ByLv2();
        String[] testCase1 = {"Enter uid1234 Muzi", "Enter uid4567 Prodo","Leave uid1234","Enter uid1234 Prodo","Change uid4567 Ryan"};

        String[] result = solution6ByLv2.solution(testCase1);

        String[] then = {"Prodo님이 들어왔습니다.", "Ryan님이 들어왔습니다.", "Prodo님이 나갔습니다.", "Prodo님이 들어왔습니다."};
