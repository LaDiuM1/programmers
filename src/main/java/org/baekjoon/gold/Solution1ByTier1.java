package org.baekjoon.gold;

import org.programmers.Main;
...
public class Solution1ByTier1 {
     ...
     * 움직이도록 로직 작성, 구슬이 이동할 때 각 방향에서 앞에 있는 구슬을 이동시키고 이동할 때마다
     * 구멍에 들어가는지 조건 확인, 두 구슬의 이동이 끝난 후 각 구슬의 구멍에 들어갔는지 여부를 확인
